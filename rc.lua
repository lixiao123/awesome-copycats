...
-- {{{ Tags
tags = {
   names = { "web", "terminal", "mail", "file", "other"},
   layout = { layouts[1], layouts[3], layouts[1], layouts[1], layouts[4] }
}
...
globalkeys = awful.util.table.join(
	...
	awful.key({ modkey }, "p", function () awful.util.spawn_with_shell("dbus-launch pcmanfm &") end),
...
wp_index = 1
wp_timeout = 600
wp_path = "/home/foree/Pictures/backgroud_desktop/"
--wp_files = {"background_1.png", "background_2.png", "background_3.png" }
